...
SNAL_DIR = '/home/hhchoi1022/snal/data_OSC/'
...
def _read_ngsf_classification_fit(path):
    """Return first row of NGSF formatted table, or None if missing or unreadable (failed fit)."""
    path = Path(path)
    if not path.is_file():
        return None
    try:
...
# for row in good_meta_tbl:
#     objname = row['objname']
#     objtype = row['transient_type']
...
#         obsdate = spectra_meta['mjd']
#         base = Path(SNAL_DIR) / objname
#         classification_result_raw = _read_ngsf_classification_fit(
#             base / f"{objname}_spectra_{spectra_idx}_ngsf_raw_formatted.fit"
#         )
#         classification_result_medium0 = _read_ngsf_classification_fit(
#             base / f"{objname}_spectra_{spectra_idx}_ngsf_medium0_formatted.fit"
#         )
#         classification_result_medium1 = _read_ngsf_classification_fit(
#             base / f"{objname}_spectra_{spectra_idx}_ngsf_medium1_formatted.fit"
#         )
#         classification_result_medium2 = _read_ngsf_classification_fit(
#             base / f"{objname}_spectra_{spectra_idx}_ngsf_medium2_formatted.fit"
#         )
#         classification_result_medium3 = _read_ngsf_classification_fit(
#             base / f"{objname}_spectra_{spectra_idx}_ngsf_medium3_formatted.fit"
#         )
#         classification_result_medium4 = _read_ngsf_classification_fit(
#             base / f"{objname}_spectra_{spectra_idx}_ngsf_medium4_formatted.fit"
#         )
#         classification_result_medium5 = _read_ngsf_classification_fit(
#             base / f"{objname}_spectra_{spectra_idx}_ngsf_medium5_formatted.fit"
#         )
#         result_dict_raw = {}
#         result_dict_raw['min_wl'] = np.min(spectra_data['wavelength'])
#         result_dict_raw['max_wl'] = np.max(spectra_data['wavelength'])
#         result_dict_raw['num_synphot'] = 100
#         result_dict_raw['num_filterset'] = 100
#         if classification_result_raw is not None:
#             result_dict_raw.update(dict(classification_result_raw))
#         result_dict_medium0 = {}
#         result_dict_medium0['min_wl'] = np.min(spectra_data['wavelength'])
#         result_dict_medium0['max_wl'] = np.max(spectra_data['wavelength'])
#         result_dict_medium0['num_synphot'] = len(synphot_tbl[np.isin(synphot_tbl['filter'], medium_filterset_0)])
#         result_dict_medium0['num_filterset'] = len(medium_filterset_0)
#         if classification_result_medium0 is not None:
#             result_dict_medium0.update(dict(classification_result_medium0))
#         result_dict_medium1 = {}
#         result_dict_medium1['min_wl'] = np.min(spectra_data['wavelength'])
#         result_dict_medium1['max_wl'] = np.max(spectra_data['wavelength'])
#         result_dict_medium1['num_synphot'] = len(synphot_tbl[np.isin(synphot_tbl['filter'], medium_filterset_1)])
#         result_dict_medium1['num_filterset'] = len(medium_filterset_1)
#         if classification_result_medium1 is not None:
#             result_dict_medium1.update(dict(classification_result_medium1))
#         result_dict_medium2 = {}
#         result_dict_medium2['min_wl'] = np.min(spectra_data['wavelength'])
#         result_dict_medium2['max_wl'] = np.max(spectra_data['wavelength'])
#         result_dict_medium2['num_synphot'] = len(synphot_tbl[np.isin(synphot_tbl['filter'], medium_filterset_2)])
#         result_dict_medium2['num_filterset'] = len(medium_filterset_2)
#         if classification_result_medium2 is not None:
#             result_dict_medium2.update(dict(classification_result_medium2))
#         result_dict_medium3 = {}
#         result_dict_medium3['min_wl'] = np.min(spectra_data['wavelength'])
#         result_dict_medium3['max_wl'] = np.max(spectra_data['wavelength'])
#         result_dict_medium3['num_synphot'] = len(synphot_tbl[np.isin(synphot_tbl['filter'], medium_filterset_3)])
#         result_dict_medium3['num_filterset'] = len(medium_filterset_3)
#         if classification_result_medium3 is not None:
#             result_dict_medium3.update(dict(classification_result_medium3))
#         result_dict_medium4 = {}
#         result_dict_medium4['min_wl'] = np.min(spectra_data['wavelength'])
#         result_dict_medium4['max_wl'] = np.max(spectra_data['wavelength'])
#         result_dict_medium4['num_synphot'] = len(synphot_tbl[np.isin(synphot_tbl['filter'], medium_filterset_4)])
#         result_dict_medium4['num_filterset'] = len(medium_filterset_4)
#         if classification_result_medium4 is not None:
#             result_dict_medium4.update(dict(classification_result_medium4))
#         result_dict_medium5 = {}
#         result_dict_medium5['min_wl'] = np.min(spectra_data['wavelength'])
#         result_dict_medium5['max_wl'] = np.max(spectra_data['wavelength'])
#         result_dict_medium5['num_synphot'] = len(synphot_tbl[np.isin(synphot_tbl['filter'], medium_filterset_5)])
#         result_dict_medium5['num_filterset'] = len(medium_filterset_5)
#         if classification_result_medium5 is not None:
#             result_dict_medium5.update(dict(classification_result_medium5))
#         result_dict_raw.update(spectra_meta)
#         result_dict_raw.update(dict(row))
#         result_dict_medium0.update(spectra_meta)
#         result_dict_medium0.update(dict(row))
#         result_dict_medium1.update(spectra_meta)
#         result_dict_medium1.update(dict(row))
#         result_dict_medium2.update(spectra_meta)
#         result_dict_medium2.update(dict(row))
#         result_dict_medium3.update(spectra_meta)
#         result_dict_medium3.update(dict(row))
#         result_dict_medium4.update(spectra_meta)
#         result_dict_medium4.update(dict(row))
#         result_dict_medium5.update(spectra_meta)
#         result_dict_medium5.update(dict(row))
#         all_results_dict_raw.append(result_dict_raw)
...
#         all_results_dict_medium5.append(result_dict_medium5)
    # print(f'Real: {objtype} [{float(obsdate) - maxdate}], Predicted0: {classification_result_medium0["SN_TYPE"]} [{classification_result_medium0["Phase"]}], Chisq: {classification_result_medium0["CHI2/dof2"]}')
    # print(f'Real: {objtype} [{float(obsdate) - maxdate}], Predicted1: {classification_result_medium1["SN_TYPE"]} [{classification_result_medium1["Phase"]}], Chisq: {classification_result_medium1["CHI2/dof2"]}')
    # print(f'Real: {objtype} [{float(obsdate) - maxdate}], Predicted2: {classification_result_medium2["SN_TYPE"]} [{classification_result_medium2["Phase"]}], Chisq: {classification_result_medium2["CHI2/dof2"]}')
    # print(f'Real: {objtype} [{float(obsdate) - maxdate}], Predicted3: {classification_result_medium3["SN_TYPE"]} [{classification_result_medium3["Phase"]}], Chisq: {classification_result_medium3["CHI2/dof2"]}')
    # print(f'Real: {objtype} [{float(obsdate) - maxdate}], Predicted4: {classification_result_medium4["SN_TYPE"]} [{classification_result_medium4["Phase"]}], Chisq: {classification_result_medium4["CHI2/dof2"]}')
...
#%%
# all_tables_tbl_raw = Table.read(Path(SNAL_DIR) / f'NGSF_all_results_tbl_raw{version}.csv', format='ascii.fixed_width')
# all_results_tbl_medium0 = Table.read(Path(SNAL_DIR) / f'NGSF_all_results_tbl_medium0{version}.csv', format='ascii.fixed_width')
all_results_tbl_medium1 = Table.read(Path(SNAL_DIR) / f'NGSF_all_results_tbl_medium1{version}.csv', format='ascii.fixed_width')
all_results_tbl_medium2 = Table.read(Path(SNAL_DIR) / f'NGSF_all_results_tbl_medium2{version}.csv', format='ascii.fixed_width')
all_results_tbl_medium3 = Table.read(Path(SNAL_DIR) / f'NGSF_all_results_tbl_medium3{version}.csv', format='ascii.fixed_width')
all_results_tbl_medium4 = Table.read(Path(SNAL_DIR) / f'NGSF_all_results_tbl_medium4{version}.csv', format='ascii.fixed_width')
all_results_tbl_medium5 = Table.read(Path(SNAL_DIR) / f'NGSF_all_results_tbl_medium5{version}.csv', format='ascii.fixed_width')
#%%
...
def add_ngsf_metadata_comparison(tbl):
    ...
    """
    n = len(tbl)
    mjd = _col_to_float_array(tbl['mjd'], n)
...
# NGSF_RESULTS_RAW = Path(f'{SNAL_DIR}/NGSF_all_results_tbl_raw{version}.csv')
...
# wl_min = 5000
# wl_max = 7000
# all_results_tbl_raw_comp = all_results_tbl_raw_comp[(all_results_tbl_raw_comp['min_wl'] <= wl_min) & (all_results_tbl_raw_comp['max_wl'] >= wl_max)]
# #%%
...
#     stem=f'NGSF_accuracy_raw{version}',
...
# Default path (override to use e.g. /home/hhchoi1022/snal/data/NGSF_all_results_tbl_medium0.csv)
NGSF_RESULTS_MEDIUM0 = Path(f'{SNAL_DIR}/NGSF_all_results_tbl_medium0{version}.csv')
...
wl_min = 5000
wl_max = 7000
all_results_tbl_medium0_comp = all_results_tbl_medium0_comp[(all_results_tbl_medium0_comp['min_wl'] <= wl_min) & (all_results_tbl_medium0_comp['max_wl'] >= wl_max)]
# all_results_tbl_medium0_comp = all_results_tbl_medium0_comp[all_results_tbl_medium0_comp['num_synphot'] > 15]
#%%
...
plot_ngsf_accuracy_four_panels(
    ...
    stem=f'NGSF_accuracy_medium0{version}',
    title_prefix=f'NGSF medium0{version}',
    transient_type=NGSF_PLOT_TRANSIENT_TYPE,
)
#%%
NGSF_RESULTS_MEDIUM1 = Path(f'{SNAL_DIR}/NGSF_all_results_tbl_medium1{version}.csv')
...
wl_min = 5000
wl_max = 7000
all_results_tbl_medium1_comp = all_results_tbl_medium1_comp[(all_results_tbl_medium1_comp['min_wl'] <= wl_min) & (all_results_tbl_medium1_comp['max_wl'] >= wl_max)]
# all_results_tbl_medium1_comp = all_results_tbl_medium1_comp[all_results_tbl_medium1_comp['num_synphot'] > 15]
#%%
...
plot_ngsf_accuracy_four_panels(
    ...
    stem=f'NGSF_accuracy_medium1{version}',
    title_prefix=f'NGSF medium1{version}',
    transient_type=NGSF_PLOT_TRANSIENT_TYPE,
)

#%%
NGSF_RESULTS_MEDIUM2 = Path(f'{SNAL_DIR}/NGSF_all_results_tbl_medium2{version}.csv')
...
wl_min = 5000
wl_max = 7000
all_results_tbl_medium2_comp = all_results_tbl_medium2_comp[(all_results_tbl_medium2_comp['min_wl'] <= wl_min) & (all_results_tbl_medium2_comp['max_wl'] >= wl_max)]
# all_results_tbl_medium2_comp = all_results_tbl_medium2_comp[all_results_tbl_medium2_comp['num_synphot'] > 15]
#%%
...
plot_ngsf_accuracy_four_panels(
    ...
    stem=f'NGSF_accuracy_medium2{version}',
    title_prefix=f'NGSF medium2{version}',
    transient_type=NGSF_PLOT_TRANSIENT_TYPE,
)

#%%
NGSF_RESULTS_MEDIUM3 = Path(f'{SNAL_DIR}/NGSF_all_results_tbl_medium3{version}.csv')
...
wl_min = 5000
wl_max = 7000
all_results_tbl_medium3_comp = all_results_tbl_medium3_comp[(all_results_tbl_medium3_comp['min_wl'] <= wl_min) & (all_results_tbl_medium3_comp['max_wl'] >= wl_max)]
#%%
...
plot_ngsf_accuracy_four_panels(
    ...
    stem=f'NGSF_accuracy_medium3{version}',
    title_prefix=f'NGSF medium3{version}',
    transient_type=NGSF_PLOT_TRANSIENT_TYPE,
)

#%%
NGSF_RESULTS_MEDIUM4 = Path(f'{SNAL_DIR}/NGSF_all_results_tbl_medium4{version}.csv')
...
wl_min = 5000
wl_max = 7000
all_results_tbl_medium4_comp = all_results_tbl_medium4_comp[(all_results_tbl_medium4_comp['min_wl'] <= wl_min) & (all_results_tbl_medium4_comp['max_wl'] >= wl_max)]
...
plot_ngsf_accuracy_four_panels(
    ...
    stem=f'NGSF_accuracy_medium4{version}',
    title_prefix=f'NGSF medium4{version}',
    transient_type=NGSF_PLOT_TRANSIENT_TYPE,
)


# %%
NGSF_RESULTS_MEDIUM5 = Path(f'{SNAL_DIR}/NGSF_all_results_tbl_medium5{version}.csv')
...
wl_min = 5000
wl_max = 7000
all_results_tbl_medium5_comp = all_results_tbl_medium5_comp[(all_results_tbl_medium5_comp['min_wl'] <= wl_min) & (all_results_tbl_medium5_comp['max_wl'] >= wl_max)]
...
plot_ngsf_accuracy_four_panels(
    ...
    stem=f'NGSF_accuracy_medium5{version}',
    title_prefix=f'NGSF medium5{version}',
    transient_type=NGSF_PLOT_TRANSIENT_TYPE,
)
...
for _med_idx in range(6):
    ...
    _p = Path(f'/home/hhchoi1022/snal/data_OSC/{_name}')
    if not _p.is_file():
...
def plot_family_match_rate_raw_vs_medium0(
    ...
    plt.barh(y - h/2, raw_rates, height=h, label='medium[~m700]')
    plt.barh(y + h/2, med_rates, height=h, label='medium[all]')
    ...
    ylabels = [
        f"{lab}  (medium[~m700]={sr}/{nr}, medium[all]={sm}/{nm})"
...
#%%
for row in all_results_tbl_medium5_comp[~all_results_tbl_medium5_comp['type_family_match']]:
    print(row['objname'], 'File: ', row['SPECTRUM'], 'Meta: ', row['transient_type'], 'Classification: ', row['SN_TYPE'])
...
plot_family_match_rate_multi(
    raw_tbl=all_results_tbl_medium5_comp,
    medium_tbls=[all_results_tbl_medium0_comp, all_results_tbl_medium1_comp, all_results_tbl_medium2_comp ],
